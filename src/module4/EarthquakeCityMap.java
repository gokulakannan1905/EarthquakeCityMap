...
//		earthquakesURL = "test2.atom";
	...
	private void addKey() {	
		...
		text("Land Quakes", 75, 155);
		text("Ocean Quakes", 75, 185);
		text("Size ~ Magnitude",45,215);
		text("Shallow", 75, 250);
	...
	private void printQuakes() 
	{
		...
		ocean = quakeMarkers.size() - ocean;
		System.out.println("Oceans quakes: "+ ocean);
